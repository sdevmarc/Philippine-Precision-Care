    ...
    <header class="w-full h-[7vh] px-[10rem] flex justify-between items-center z-[2] bg-white">
        ...
        <div class="w-[70%] h-full flex justify-end items-center gap-[2rem]">
            <div class="hr relative">
                ...
                <div
                    class="hr-content absolute top-[1.5rem] w-[13rem] left-[-2rem] hidden bg-[#a30000] rounded-xl py-[1rem] px-[1rem]">
            ...
            <div class="hr relative">
                ...
                <div
                    class="hr-content absolute top-[1.5rem] w-[13rem] left-[-4rem] hidden bg-[#a30000] rounded-xl py-[1rem] px-[1rem]">
            ...
            <div class="hr relative">
                ...
                <div
                    class="hr-content absolute top-[1.5rem] w-[13rem] left-[-3rem] hidden bg-[#a30000] rounded-xl py-[1rem] px-[1rem]">
            ...
            <button id="logoutButton"
                ...
                <a href="../../backend/logout.php" style="text-decoration: none; color: white;">Logout</a>
            </button>
