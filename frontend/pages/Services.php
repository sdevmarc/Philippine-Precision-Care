...
<body>
    ...
    <div class="w-full py-[5rem] bg-[#ffffff] px-[2rem] sm:px-[5rem] md:px-[10rem] lg:px-[20rem] flex flex-col items-center">
        ...
        <div class="w-full flex flex-col items-start gap-[2rem]">
            <h2 class="text-[1.5rem] sm:text-[2rem] md:text-[2.5rem] text-black font-bold">Appointments</h2>
            ...
            <ul class="list-disc pl-[1.5rem]">
                <li class="text-[1rem] sm:text-[1.2rem] md:text-[1.5rem]">Blood Tests</li>
                <li class="text-[1rem] sm:text-[1.2rem] md:text-[1.5rem]">Diagnostic Imaging</li>
                <li class="text-[1rem] sm:text-[1.2rem] md:text-[1.5rem]">General Health Check-ups</li>
                <li class="text-[1rem] sm:text-[1.2rem] md:text-[1.5rem]">Specialist Consultations</li>
            </ul>
        </div>
    </div>
