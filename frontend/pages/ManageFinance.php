...
<body>
    ...
    <div class="w-full h-[93vh] flex flex-col justify-start items-center px-[5rem]">
        <div class="w-full h-[10%] flex items-center">
            <h1 class="text-black text-[2rem] font-[700]">MANAGE FINANCE</h1>
        </div>
                ...
                <tbody>
                    <tr class="border border text-black">
                        ...
                        <td class="border border-black text-black px-[1rem] text-center truncate">
                            <button onclick="openEditForm()" class="px-[1.5rem] py-[.3rem] mx-[.2rem] my-[.4rem] bg-[#3076f0] text-[.9rem] text-white font-[600] rounded-xl duration-300 ease hover:scale-[.98] hover:opacity-[.6]">
                                Edit
                            </button>
    ...
    <div id="editFormOverlay" class="hidden absolute top-0 left-0 w-full h-screen bg-[#000] bg-opacity-[.3] flex justify-center items-center z-[1]">
        <form id="editForm" action="" class="relative w-[70rem] h-[35rem] bg-white rounded-xl shadow-[0_10px_15px_-3px_rgba(0,0,0,0.1)] flex flex-col justify-start items-center">
            ...
            <div class="overflow-auto w-full flex flex-col gap-[1rem]  px-[1.5rem] py-[1.5rem]">
                <h1 class="text-[1.5rem] font-[700] text-black">Edit Sample</h1>
