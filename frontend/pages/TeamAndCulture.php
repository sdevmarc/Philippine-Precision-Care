...
<body>
    ...
    <header class="sticky top-0 w-full h-[5rem] px-[10rem] flex justify-between items-center z-[2] bg-white">
        ...
        <div class="navs w-[70%] h-full flex justify-end items-center gap-[.5rem]">
            ...
            <a href="./TeamAndCulture.php" class="active text-[1rem] font-[400] text-black px-[1.5rem] py-[.4rem] rounded-[1rem] duration-300 ease hover:bg-[#111] hover:bg-opacity-[.6] hover:text-white">
                Team & Culture
            </a>
        ...
        <div class="w-full flex flex-col items-start gap-[2rem]">
            <div class="w-full flex justify-evenly items-center gap-[2rem]">
                <div class="w-[24rem] h-[27rem] flex flex-col justify-center items-center gap-[1rem]">
                    ...
                    <h1 class="text-[1.5rem] font-[600]">Dr. Marc Edison</h1>
                </div>
                <div class="w-[24rem] h-[27rem]  flex flex-col justify-center items-center gap-[1rem]">
                    <div class="overflow-hidden w-full h-full rounded-[50%] flex justify-center items-start">
                        <img src="../assets/Tonasd.png" alt="Marc" class="object-cover w-full h-full">
                    </div>
                    <h1 class="text-[1.5rem] font-[600]">Dr. Ton Yacapin</h1>
                </div>
                <div class="w-[24rem] h-[27rem]  flex flex-col justify-center items-center gap-[1rem]">
                    <div class="overflow-hidden w-full h-full rounded-[50%] flex justify-center items-start">
                ...
                <div class="w-[24rem] h-[27rem] flex flex-col justify-center items-center gap-[1rem]">
                    ...
                    <h1 class="text-[1.5rem] font-[600]">Mr. Melbraei Santiago</h1>
                </div>
            ...
            <p class="text-[1rem] sm:text-[1.2rem] md:text-[1.5rem] text-justify">
                At Philippine Precision Care, we foster a culture of excellence, empathy, and continuous learning. Our team is dedicated to improving healthcare standards and delivering compassionate care to our patients.
            </p>
        </div>
    </div>
